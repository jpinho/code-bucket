...
//@summary: given a string @str reverses it in place, without aux variables.
//@params: @str - string to be processed
void reverse(char* str)
{
    ...
    //for string with odd number of characters there is no need to switch
    //the middle caracter, so when the pointer [s] becames bigger than [e]
    //all caracters have been properly switched.
